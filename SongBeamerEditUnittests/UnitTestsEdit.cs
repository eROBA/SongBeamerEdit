...
namespace UnitTests
{
    ...
    public class UnitTestsEdit
    {
        ...
        public void NurEinVersMitVerskennzeichnung()
        {
            ...
            SongEdit testVMSongbeamerFormat = new SongEdit(Testsong1);
        ...
        public void NurEinVersOhneVerskennzeichnung()
        {
            ...
            SongEdit testVMSongbeamerFormat = new SongEdit(Testsong2);
            Debug.Print("{0}", testVMSongbeamerFormat.Ergebnis);
            //Assert
            Assert.IsTrue(testVMSongbeamerFormat.Ergebnis == ErgebnisTestsong1);
        }
        ...
        public void NurEinChorusVerskennzeichnung()
        {
            ...
            SongEdit testVMSongbeamerFormat = new SongEdit(Testsong3);
            Debug.Print("{0}", testVMSongbeamerFormat.Ergebnis);
            //Assert
            Assert.IsTrue(testVMSongbeamerFormat.Ergebnis == ErgebnisTestsong1);
        }
        ...
        public void NurEinVersMitVerskennzeichnungZweiSprachen()
        {
            ...
            SongEdit testVMSongbeamerFormat = new SongEdit(Testsong4);
            Debug.Print("{0}", testVMSongbeamerFormat.Ergebnis);
            //Assert
        ...
        public void MehrereVerseOhneKennzeichnung()
        {
            ...
            SongEdit testVMSongbeamerFormat= new SongEdit(Testsong5);
            Debug.Print("{0}", testVMSongbeamerFormat.Ergebnis);
            //Assert
        ...
        public void MitVersenUndRefrain()
        {
            ...
            SongEdit testVMSongbeamerFormat= new SongEdit(Testsong6);
            Debug.Print("{0}", testVMSongbeamerFormat.Ergebnis);
            //Assert
        ...
        public void MitVersenUndRefrains()
        {
            ...
            SongEdit testVMSongbeamerFormat= new SongEdit(Testsong7);
            Debug.Print("{0}", testVMSongbeamerFormat.Ergebnis);
            //Assert
        ...
        public void RefrainVersNrMehrmals()
        {
            ...
            SongEdit testVMSongbeamerFormat= new SongEdit(Testsong8);
            Debug.Print("{0}", testVMSongbeamerFormat.Ergebnis);
            //Assert
