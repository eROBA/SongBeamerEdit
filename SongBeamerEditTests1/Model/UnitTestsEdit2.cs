...
namespace UnitTests
{
    ...
    public class UnitTestsEdit
    {
        ...
        public void NurEinVersMitVerskennzeichnung()
        {
            ...
            string ErgebnisTestsong1 = "---\r\nVers\r\nPrecious name, O how sweet!\r\nHope of earth and joy of heaven.\r\nPrecious name, O how sweet!\r\nHope of earth and joy of heaven.\r\nPrecious name, O how sweet!\r\nHope of earth and joy of heaven.\r\nPrecious name, O how sweet!\r\nHope of earth and joy of heaven.\r\nPrecious name, O how sweet!\r\nHope of earth and joy of heaven.\r\nPrecious name, O how sweet!\r\nHope of earth and joy of heaven.\r\n";
            //Act
            Debug.Print("Der original Songtext\n{0}\nDas ist das Ende vom original Songtext", Testsong1);
            Song testVMSongbeamerFormat = new Song(Testsong1);
            string test = testVMSongbeamerFormat.VerseList.ToString();
            Debug.Print("{0}", testVMSongbeamerFormat.VerseList.ToString());
            //Assert
            Assert.IsTrue(testVMSongbeamerFormat.VerseList.ToString() == ErgebnisTestsong1);
        }
        [TestMethod]
        public void NurEinVersOhneVerskennzeichnung()
        {
            ...
            Song testVMSongbeamerFormat = new Song(Testsong2);
            string test = testVMSongbeamerFormat.VerseList.ToString();
            Debug.Print("{0}", testVMSongbeamerFormat.VerseList.ToString());
            //Assert
            Assert.IsTrue(testVMSongbeamerFormat.VerseList.ToString() == ErgebnisTestsong1);
        ...
        public void NurEinChorusVerskennzeichnung()
        {
            ...
            Song testVMSongbeamerFormat = new Song(Testsong3);
            string test = testVMSongbeamerFormat.VerseList.ToString();
            Debug.Print("{0}", testVMSongbeamerFormat.VerseList.ToString());
            //Assert
            Assert.IsTrue(testVMSongbeamerFormat.VerseList.ToString() == ErgebnisTestsong1);
        ...
        //    Song testVMSongbeamerFormat = new Song(Testsong4);
        //    Debug.Print("{0}", testVMSongbeamerFormat.VerseList.ToString());
        //    //Assert
        //    Assert.IsTrue(testVMSongbeamerFormat.VerseList.ToString() == ErgebnisTestsong4);
        //}
        //[TestMethod]
        ...
        //    Song testVMSongbeamerFormat= new Song(Testsong5);
        //    Debug.Print("{0}", testVMSongbeamerFormat.VerseList.ToString());
        //    //Assert
        //    Assert.IsTrue(testVMSongbeamerFormat.VerseList.ToString() == SollTestsong5);
        //    Assert.IsTrue(testVMSongbeamerFormat.LanguageCount == 1);
        ...
        //    Song testVMSongbeamerFormat= new Song(Testsong6);
        //    Debug.Print("{0}", testVMSongbeamerFormat.VerseList.ToString());
        //    //Assert
        //    Assert.IsTrue(testVMSongbeamerFormat.VerseList.ToString() == SollTestsong6);
        //    Assert.IsTrue(testVMSongbeamerFormat.LanguageCount == 1);
        //    //Assert.IsTrue(testVMSongbeamerFormat.MaxAnzahlZeilenProSeite == 2);
        ...
        //    Song testVMSongbeamerFormat= new Song(Testsong7);
        //    Debug.Print("{0}", testVMSongbeamerFormat.VerseList.ToString());
        //    //Assert
        //    Assert.IsTrue(testVMSongbeamerFormat.VerseList.ToString() == SollTestsong7);
        //    Assert.IsTrue(testVMSongbeamerFormat.LanguageCount == 1);
        //    //Assert.IsTrue(testVMSongbeamerFormat.MaxAnzahlZeilenProSeite == 2);
        ...
        //    Song testVMSongbeamerFormat= new Song(Testsong8);
        //    Debug.Print("{0}", testVMSongbeamerFormat.VerseList.ToString());
        //    //Assert
        //    Assert.IsTrue(testVMSongbeamerFormat.VerseList.ToString() == SollTestsong8);
        //    Assert.IsTrue(testVMSongbeamerFormat.LanguageCount == 1);
        //Assert.IsTrue(testVMSongbeamerFormat.MaxAnzahlZeilenProSeite == 2);
